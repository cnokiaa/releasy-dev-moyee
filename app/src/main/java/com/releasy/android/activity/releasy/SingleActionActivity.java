...
public class SingleActionActivity extends RelesyBaseActivity{
	...
	private void contrastWorking(){
        ...
        showLogD("Strength : " + app.getAction().getStrength());
        //powerBar.setPower(app.getAction().getStrength());
        
        powerCurrent = app.getAction().getStrength();
	...
	/*private void setCircularSeekbar(int maxProgress, int progress, boolean openTouch){
		...
		if(openTouch)
			circularSeekbar.showSeekBar();  //展示时间小圈
		else
			circularSeekbar.hideSeekBar();  //隐藏时间小圈
		...
		navRightImg.setOnClickListener(new OnClickListener(){
			public void onClick(View arg0) {
				...
				/*if(spInfo.getMusicCursor()){
					Toast.makeText(SingleActionActivity.this, R.string.music_permission_msg, Toast.LENGTH_LONG).show();
				}*/
		...
		switchImg.setOnClickListener(new OnClickListener(){
			public void onClick(View arg0) {
				if(deviceList.size() == 0){
					Toast.makeText(SingleActionActivity.this, R.string.currently_no_device, Toast.LENGTH_LONG).show();
					return;
				}
	...
	private final BroadcastReceiver broadcastReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if(BleWorkService.ACTION_GATT_DISCONNECTED.equals(action)){
				...
				String deviceStr = SingleActionActivity.this.getString(R.string.device) + " ";
				String connectionIsbroken = " " + SingleActionActivity.this.getString(R.string.connection_is_broken);
				String address = bundle.getString("data");
				Toast.makeText(SingleActionActivity.this, deviceStr + address + connectionIsbroken, Toast.LENGTH_LONG).show();
				...
				showAlertDialog(SingleActionActivity.this.getString(R.string.prompt)
						,SingleActionActivity.this.getString(R.string.no_device_connect)
						,SingleActionActivity.this.getString(R.string.confirm));
			}
			...
			if(BleWorkService.DEVICE_IS_NOT_LOAD.equals(action)){
				String toastStr1 = SingleActionActivity.this.getString(R.string.device);
				String toastStr2 = SingleActionActivity.this.getString(R.string.not_affixed_to_the_body);
				Toast.makeText(SingleActionActivity.this, toastStr1 
			...
			if(BleWorkService.DEVICE_ALL_IS_NOT_LOAD.equals(action)){
				...
				showAlertDialog(SingleActionActivity.this.getString(R.string.prompt)
						,SingleActionActivity.this.getString(R.string.no_device_attached_to_the_body)
						,SingleActionActivity.this.getString(R.string.confirm));
			}
	}};
	...
	private class OutTimeHandler extends Handler{
		public void handleMessage(Message msg) {
			...
			if(spInfo.getSelectDevice().equals(Constants.SELECT_DEVICE_M2)){
				...
				device = SingleActionActivity.this.getString(R.string.device);
				connectFailure = SingleActionActivity.this.getString(R.string.connect_failure);
				
				Toast.makeText(SingleActionActivity.this, device + connectFailure
				...
				case OPEN:
					...
					Toast.makeText(SingleActionActivity.this, device + " " 
